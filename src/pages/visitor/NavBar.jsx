      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex space-x-6 items-center">
            ...
            <a href="#" className="px-4 py-1 font-bold rounded-full hover:bg-gray-200" style={{backgroundColor: "#CCD5B9", color:"#585233" }}>Log in</a>
            <a href="#" className="px-4 py-1 border rounded-full " style={{ borderColor: "#CCD5B9" }}>Sign Up</a>
          </div>
...
>
          <a href="#home" className="block px-3 py-2 rounded-md hover:bg-olive-700">Home</a>
          <a href="#aboutus" className="block px-3 py-2 rounded-md hover:bg-olive-700">About us</a>
          <a href="#services" className="block px-3 py-2 rounded-md hover:bg-olive-700">Services</a>
          <a href="#contact" className="block px-3 py-2 rounded-md hover:bg-olive-700">Contact</a>
