...
import Stepper, { Step } from '../../imports/Stepper';
                ...
                >
                    ...
                    >
                        ...
                        <input value={name} type='text' required onChange={(e) => setName(e.target.value)} placeholder="Your name?"
                            style={{ width: '100%', borderRadius: '8px', border: '2px solid #585233', paddingLeft: '10px' }}
                        />
                    </Step>
                    <Step
                        validateNext={() => {
                    ...
                    >
                        ...
                        <textarea value={text} required onChange={(e) => setText(e.target.value)}
                            style={{ height: '4rem', width: '100%', borderRadius: '8px', border: '2px solid #585233' }}
                        />
                    </Step>
                    <Step>
