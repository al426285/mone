        ...
        <div className='aboutus'>
            ...
            <div className="englobado ml-20 mr-20 mb-20">
                <div className="imagengrupo w-2/5 ">
                    <img src="../../../img/imagen_grupal.png" alt="imagen del grupo"
                ...
                <div className="nosotros w-3/5">
                    ...
                    md:text-xl lg:text-1xl'>We are a team of three students — Teresa, Ernesto, and Haytame — who designed this map-based application as part of our Software Paradigms and Software Design course.
                        <br />
